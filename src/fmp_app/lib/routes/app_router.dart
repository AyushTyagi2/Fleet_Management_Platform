...
import 'package:fmp_app/presentation/auth/email_input/email_input_screen.dart';
...
class AppRouter {
  ...
  static const email             = '/email';          // was '/phone'
  ...
  static const createShipment    = '/create-shipment';
  ...
  static final routes = <String, WidgetBuilder>{
    ...
    email:             (_) => const EmailInputScreen(),   // was PhoneInputScreen
